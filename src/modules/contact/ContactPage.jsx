...
const ContactPage = () => {
  ...
  const contactInfo = {
    ...
    socialMedia: {
      instagram: 'https://www.instagram.com/haize',
      facebook: 'https://www.facebook.com/haize',
      tiktok: 'https://www.tiktok.com/@haize',
      youtube: 'https://www.youtube.com/@haize',
    },
  };
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="border border-gray-200 rounded-sm p-8 mb-16">
          ...
          <div className="flex justify-center gap-6">
            ...
            >
              <svg
                className="w-8 h-8 text-gray-900 group-hover:scale-110 transition-transform"
                fill="currentColor"
                viewBox="0 0 24 24"
              >

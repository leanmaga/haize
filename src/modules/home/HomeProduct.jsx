...
export default function HomeProduct({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/20 to-transparent md:bg-linear-to-t md:from-black/40 md:via-transparent md:to-transparent" />

...
const AdminQuestionsPage = () => {
  ...
  const isResponseValid = (text) => text.trim().length >= 10;

  const canSubmitResponse = () => !submitting && isResponseValid(responseText);
  ...
  const handleButtonMouseEvents = (e, isEnter) => {
    if (canSubmitResponse()) {
      e.target.style.backgroundColor = isEnter ? '#4B5563' : '#000000';
    }
  };
  ...
  const handleRespond = async (questionId) => {
    ...
    try {
      ...
      if (data.success) {
        toast.success(
          'Respuesta enviada correctamente. El usuario ha sido notificado por email.',
        );
  ...
  }, [isAdmin, filter, currentPage, fetchQuestions]);
  ...
  }, [isAdmin, stats.pending, fetchQuestions]);
    ...
    <div className="space-y-3">
      ...
      <div className="flex space-x-2">
        <button
          ...
          onMouseEnter={(e) => handleButtonMouseEvents(e, true)}
          onMouseLeave={(e) => handleButtonMouseEvents(e, false)}
        ...
        <button
          ...
          className="px-3 py-2 bg-gray-200 text-gray-800 text-sm font-medium rounded-md hover:bg-gray-300 transition-colors"
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            {stats.pending > 0 && (
              <div className="bg-orange-50 border border-orange-200 rounded-lg px-4 py-2 flex items-center space-x-2">
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              disabled={refreshing}
              className="flex items-center space-x-2 px-3 py-2 text-sm text-white bg-black rounded-md hover:bg-gray-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
              aria-label="Actualizar lista de preguntas"
            >
              <ArrowPathIcon
              ...
              {filteredQuestions.map((question) => (
                ...
                >
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-gray-900 bg-blue-50 border-l-4 border-blue-400 p-3 rounded-lg">
                      {question.comment}
                    </p>
                  </div>
                    ...
                    <div>
                      {respondingTo === question._id ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center px-3 py-2 text-white text-sm font-medium rounded-md transition-colors bg-black hover:bg-gray-700"
          ...
          {totalPages > 1 && (
            ...
            >
              <button
                ...
                className="px-3 py-2 border rounded text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"

...
const legalDocuments = {
  terms: {
    ...
    content: `
      <h1 class="text-2xl font-nexa-bold mb-6 text-gray-800">TÉRMINOS Y CONDICIONES DE USO</h1>
      
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">1. INTRODUCCIÓN</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">2. DEFINICIONES</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">3. USO DEL SITIO WEB</h2>
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">3.1. Elegibilidad</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">3.2. Cuenta de Usuario</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">3.3. Restricción de Venta</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">3.4. Conducta del Usuario</h3>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">4. PRODUCTOS Y SERVICIOS</h2>
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">4.1. Disponibilidad de Productos</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">4.2. Descripción de Productos</h3>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">5. PRECIOS Y PAGOS</h2>
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">5.1. Precios</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">5.2. Métodos de Pago</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">5.3. Seguridad en los Pagos</h3>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">6. ENVÍOS Y ENTREGAS</h2>
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">6.1. Política de Envíos</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">6.2. Costos de Envío</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">6.3. Plazos de Entrega</h3>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">7. POLÍTICA DE DEVOLUCIONES Y GARANTÍA</h2>
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">7.1. Garantía</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">7.2. Devoluciones</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">7.3. Condiciones para la Devolución</h3>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">8. PROPIEDAD INTELECTUAL</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">9. LIMITACIÓN DE RESPONSABILIDAD</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">10. LEGISLACIÓN APLICABLE Y JURISDICCIÓN</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">11. MODIFICACIONES A LOS TÉRMINOS</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">12. CONTACTO</h2>
  ...
  privacy: {
    ...
    content: `
      <h1 class="text-2xl font-nexa-bold mb-6 text-gray-800">POLÍTICA DE PRIVACIDAD</h1>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">2. INFORMACIÓN QUE RECOPILAMOS</h2>
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">2.1. Información Personal</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">2.2. Información de Uso</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">2.3. Cookies y Tecnologías Similares</h3>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">3. CÓMO UTILIZAMOS SU INFORMACIÓN</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">4. COMPARTICIÓN DE INFORMACIÓN</h2>
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">4.1. Proveedores de Servicios</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">4.2. Requisitos Legales</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">4.3. Transferencias Comerciales</h3>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">5. SEGURIDAD DE LA INFORMACIÓN</h2>
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">5.1. Medidas de Seguridad</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">5.2. Almacenamiento de Datos</h3>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">6. SUS DERECHOS</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">7. RETENCIÓN DE DATOS</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">8. MENORES DE EDAD</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">9. ENLACES A SITIOS DE TERCEROS</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">10. CAMBIOS A ESTA POLÍTICA</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">11. CONTACTO</h2>
  ...
  cookies: {
    ...
    content: `
      <h1 class="text-2xl font-nexa-bold mb-6 text-gray-800">CONFIGURACIÓN DE COOKIES</h1>
      
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">1. ¿QUÉ SON LAS COOKIES?</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">2. TIPOS DE COOKIES QUE UTILIZAMOS</h2>
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">2.1. Cookies Esenciales</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">2.2. Cookies de Preferencias</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">2.3. Cookies Analíticas</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">2.4. Cookies de Marketing</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">2.5. Cookies de Redes Sociales</h3>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">3. COOKIES DE TERCEROS</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">4. GESTIÓN DE COOKIES</h2>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">4.1. Cómo Deshabilitar las Cookies</h3>
      ...
      <h3 class="text-lg font-sora-regular mb-2 text-gray-700">4.2. Opciones Específicas del Navegador</h3>
      ...
      <div class="mt-8 mb-8">
        <h3 class="text-lg font-sora-regular mb-3 text-gray-700">Sus preferencias de cookies</h3>
        
        <div class="space-y-4">
          <div class="flex items-center justify-between border border-gray-300 p-4 rounded">
            <div>
              <h4 class="font-sora-regular text-gray-800">Cookies Esenciales</h4>
          ...
          <div class="flex items-center justify-between border border-gray-300 p-4 rounded">
            <div>
              <h4 class="font-sora-regular text-gray-800">Cookies Analíticas</h4>
          ...
          <div class="flex items-center justify-between border border-gray-300 p-4 rounded">
            <div>
              <h4 class="font-sora-regular text-gray-800">Cookies de Marketing</h4>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">5. COOKIES UTILIZADAS EN NUESTRO SITIO WEB</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">6. CAMBIOS EN NUESTRA POLÍTICA DE COOKIES</h2>
      ...
      <h2 class="text-xl font-sora-regular mb-4 text-gray-800">7. CONTACTO</h2>
